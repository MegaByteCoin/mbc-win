...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MBC features */
        {"mbc", "masternode", &masternode, true, true, false},
        {"mbc", "listmasternodes", &listmasternodes, true, true, false},
        {"mbc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mbc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mbc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mbc", "masternodedebug", &masternodedebug, true, true, false},
        {"mbc", "startmasternode", &startmasternode, true, true, false},
        {"mbc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mbc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mbc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mbc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mbc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mbc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mbc", "mnbudget", &mnbudget, true, true, false},
        {"mbc", "preparebudget", &preparebudget, true, true, false},
        {"mbc", "submitbudget", &submitbudget, true, true, false},
        {"mbc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mbc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mbc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mbc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mbc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mbc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mbc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mbc", "checkbudgets", &checkbudgets, true, true, false},
        {"mbc", "mnsync", &mnsync, true, true, false},
        {"mbc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> mbc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18778/\n";
}

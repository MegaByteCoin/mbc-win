...
// Copyright (c) 2018-2019 The MBC Developers
...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::MBC)
    {
    }
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    CAmount mbcAvailableBalance = balance - immatureBalance - nLockedBalance;

    // MBC Watch-Only Balance
    CAmount nTotalWatchBalance = watchOnlyBalance + watchUnconfBalance;
    CAmount nAvailableWatchBalance = watchOnlyBalance - watchImmatureBalance - nWatchOnlyLockedBalance;

    // MBC labels
    ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, mbcAvailableBalance, false, BitcoinUnits::separatorAlways));
    ...
    // MBC Available
    bool showMBCAvailable = settingShowAllBalances || mbcAvailableBalance != nTotalBalance;
    bool showWatchOnlyMBCAvailable = showMBCAvailable || nAvailableWatchBalance != nTotalWatchBalance;
    ui->labelBalanceText->setVisible(showMBCAvailable || showWatchOnlyMBCAvailable);
    ui->labelBalance->setVisible(showMBCAvailable || showWatchOnlyMBCAvailable);
    ui->labelWatchAvailable->setVisible(showMBCAvailable && showWatchOnly);

    // MBC Pending
    bool showMBCPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyMBCPending = showMBCPending || watchUnconfBalance != 0;
    ui->labelPendingText->setVisible(showMBCPending || showWatchOnlyMBCPending);
    ui->labelUnconfirmed->setVisible(showMBCPending || showWatchOnlyMBCPending);
    ui->labelWatchPending->setVisible(showMBCPending && showWatchOnly);
    ...
    // MBC Locked
    bool showMBCLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyMBCLocked = showMBCLocked || nWatchOnlyLockedBalance != 0;
    ui->labelLockedBalanceText->setVisible(showMBCLocked || showWatchOnlyMBCLocked);
    ui->labelLockedBalance->setVisible(showMBCLocked || showWatchOnlyMBCLocked);
    ui->labelWatchLocked->setVisible(showMBCLocked && showWatchOnly);
...
void OverviewPage::SetLinks()
{
    ...
    ui->labelLinks2->setText("Exchange EX-MBC:");
    ui->labelLinks3->setText("MegaByteCoin Explorer:");
    ui->labelLinks4->setText("BitcoinTalk MegaByteCoin:");
    ui->labelLinks5->setText("Github MegaByteCoin:");
    ui->labelLinks6->setText("Discord MegaByteCoin:");
	ui->labelLinks7->setText("YouTube MegaByteCoin:");

    ui->labelLinksUrl1->setText("<a href=\"https://megabytecoin.pp.ua\">MegaByteCoin.PP.UA</a>");
	ui->labelLinksUrl2->setText("<a href=\"https://ex.mbc.pp.ua\">EX.MBC.PP.UA</a>");
    ui->labelLinksUrl3->setText("<a href=\"https://explorer.megabytecoin.pp.ua\">Explorer.MegaByteCoin.PP.UA</a>");
    ui->labelLinksUrl4->setText("<a href=\"https://megabytecoin.pp.ua/bitcointalk.php\">BitCoinTalk.org</a>");
    ui->labelLinksUrl5->setText("<a href=\"https://github.com/MegaByteCoin\">GitHub.Com/MegaByteCoin</a>");
    ui->labelLinksUrl6->setText("<a href=\"https://megabytecoin.pp.ua/discord.php\">Discord.Com</a>");
    ui->labelLinksUrl7->setText("<a href=\"https://megabytecoin.pp.ua/youtube.php\">YouTube.Com<</a>");

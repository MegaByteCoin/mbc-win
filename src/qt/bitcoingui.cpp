                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MBC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MBC Core"), this);
    aboutAction->setStatusTip(tr("Show information about MBC Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the MBC Core help message to get a list with possible MBC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MBC Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("MBC Core"); // default title

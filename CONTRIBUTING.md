Contributing to MBC Core
==================================

The MBC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MBC Core project, and is not to be
confused with overall MBC Network Protocol consensus changes.

Whether a pull request is merged into MBC Core rests with the project merge
...
Patches that change MBC consensus rules are considerably more involved than
...
Where a patch set proposes to change the MBC consensus, it must have been
...
The project leader is the release manager for each MBC Core release.

...
#   c) node1 mines 32 blocks, so now node 0 has 500000MBC, node 1 has 4250MBC, node2 has none.
#   d) node0 sends 601 MBC to node2, in two transactions (301 MBC, then 300 MBC).

...
This means one can have an always-on mbcd instance running, and another local mbcd/mbc-qt instance which connects to this node and receives blocks from it.

...
RESOURCES += src/qt/mbc.qrc src/qt/mbc_locale.qrc

TRANSLATIONS += src/qt/locale/mbc_bg.ts \
                src/qt/locale/mbc_de.ts \
                src/qt/locale/mbc_en.ts \
                src/qt/locale/mbc_es.ts \
                src/qt/locale/mbc_fi.ts \
                src/qt/locale/mbc_fr.ts \
                src/qt/locale/mbc_it.ts \
                src/qt/locale/mbc_ja.ts \
                src/qt/locale/mbc_pl.ts \
                src/qt/locale/mbc_pt.ts \
                src/qt/locale/mbc_ru.ts \
                src/qt/locale/mbc_sk.ts \
                src/qt/locale/mbc_sv.ts \
                src/qt/locale/mbc_vi.ts \
                src/qt/locale/mbc_zh_CN.ts \
                src/qt/locale/mbc_zh_TW.ts

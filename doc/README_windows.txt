...
Intro
-----
MBC (MBC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. MBC utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run mbc-qt.exe.

MBC Core is the original MBC client and it builds the backbone of the network.
However, it downloads and stores the entire history of MBC transactions;

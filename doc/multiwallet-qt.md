...
In order to support loading of multiple wallets in mbc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mbc.cpp.
...
Changes to mbc.cpp
----------------------
mbc.cpp is the entry point into mbc-qt, and as such, will require some minor modifications to provide hooks for
